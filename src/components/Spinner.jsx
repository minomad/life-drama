    ...
    <div className="absolute left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 transform">
      ...
      >
        ...
        <g transform="translate(71.213 71.213) rotate(45)">
          <circle r="6" fill="#efefef" fillOpacity="0.875">
            <animateTransform
              attributeName="transform"
              begin="-0.75s"
              dur="1s"
        ...
        <g transform="translate(50 80) rotate(90)">
          <circle r="6" fill="#efefef" fillOpacity="0.75">
            <animateTransform
              attributeName="transform"
              begin="-0.625s"
              dur="1s"
        ...
        <g transform="translate(28.787 71.213) rotate(135)">
          <circle r="6" fill="#efefef" fillOpacity="0.625">
            <animateTransform
              attributeName="transform"
              begin="-0.5s"
              dur="1s"
        ...
        <g transform="translate(20 50) rotate(180)">
          <circle r="6" fill="#efefef" fillOpacity="0.5">
            <animateTransform
              attributeName="transform"
              begin="-0.375s"
              dur="1s"
        ...
        <g transform="translate(28.787 28.787) rotate(225)">
          <circle r="6" fill="#efefef" fillOpacity="0.375">
            <animateTransform
              attributeName="transform"
              begin="-0.25s"
              dur="1s"
        ...
        <g transform="translate(50 20) rotate(270)">
          <circle r="6" fill="#efefef" fillOpacity="0.25">
            <animateTransform
              attributeName="transform"
              begin="-0.125s"
              dur="1s"
        ...
        <g transform="translate(71.213 28.787) rotate(315)">
          <circle r="6" fill="#efefef" fillOpacity="0.125">
            <animateTransform
              attributeName="transform"
              begin="0s"
              dur="1s"
